...
#define WAKEUP_GPIO              2     // Only RTC IO are allowed - ESP32 Pin example
...
void setup(){
  ...
  */
  ...
  //Go to sleep now
  delay(10000); // some time for flashing new firmware before going to deep sleep
  Serial.println("Going to sleep soon");//this doesnt
  delay(10000); // some time for flashing new firmware before going to deep sleep
